...
NSString *const kVideoThumbnailSmall = @"thumbnail_small";
...
@synthesize thumbnailSmall = _thumbnailSmall;
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.thumbnailSmall = [self objectOrNilForKey:kVideoThumbnailSmall fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    NSMutableArray *tempArrayForThumbnailSmall = [NSMutableArray array];
    for (NSObject *subArrayObject in self.thumbnailSmall) {
        if([subArrayObject respondsToSelector:@selector(dictionaryRepresentation)]) {
            // This class is a model object
            [tempArrayForThumbnailSmall addObject:[subArrayObject performSelector:@selector(dictionaryRepresentation)]];
        } else {
            // Generic object
            [tempArrayForThumbnailSmall addObject:subArrayObject];
        }
    }
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForThumbnailSmall] forKey:kVideoThumbnailSmall];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.thumbnailSmall = [aDecoder decodeObjectForKey:kVideoThumbnailSmall];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_thumbnailSmall forKey:kVideoThumbnailSmall];
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    if (copy) {
        ...
        copy.thumbnailSmall = [self.thumbnailSmall copyWithZone:zone];
